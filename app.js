...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbywd5lItAeeaxMowl4rgB_affQ-fo80yeWVWzq6EsSsa536ms-LwiJuLs6Tyv2Xfk8F/exec'; // e.g. https://script.google.com/macros/s/xxxxx/exec
let currentStep = 0;
...
function showSweepstakeResult(team){
  ...
  box.hidden = false;
  box.innerHTML = `<div class="flag">${flag}</div><div><span>Your random sweepstake team is</span><strong>${safe(team)}</strong><small>If they outperform median expectations of participants in the game, you get a bonus 25 points.</small></div>`;
}
